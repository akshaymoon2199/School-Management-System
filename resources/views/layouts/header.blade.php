...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="javascript:;" style="text-align:center" class="brand-link">
      <span class="brand-text font-weight-light" style="font-weight:bold !important; font-size:20px;">School Menagement</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">     
